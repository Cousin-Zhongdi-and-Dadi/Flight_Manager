...
public:
    ...
    void setupUi(QWidget *UserPanel)
    {
        ...
        nameLabel->setGeometry(QRect(170, 120, 261, 51));
        QFont font;
        font.setPointSize(16);
        nameLabel->setFont(font);
        accountLabel = new QLabel(UserPanel);
        accountLabel->setObjectName("accountLabel");
        accountLabel->setGeometry(QRect(170, 170, 261, 51));
...
""));
        ...
        iconLabel->setStyleSheet(QString::fromUtf8("border-image: url(:/img/touxiang.jpeg);"));
        phoneLabel = new QLabel(UserPanel);
        phoneLabel->setObjectName("phoneLabel");
        phoneLabel->setGeometry(QRect(520, 120, 421, 51));
        phoneLabel->setFont(font);
        ID_Label = new QLabel(UserPanel);
        ID_Label->setObjectName("ID_Label");
        ID_Label->setGeometry(QRect(520, 170, 531, 51));
        ...
        backwardButton_2->setCursor(QCursor(Qt::CursorShape::ArrowCursor));
...
""));
        ...
        logoutButton->setCursor(QCursor(Qt::CursorShape::ArrowCursor));
...
""));
        ...
        phoneLabel->raise();
        ID_Label->raise();
        backwardButton_2->raise();
        changePersonInfoButton->raise();
        logoutButton->raise();
        refreshButton->raise();
        iconLabel->raise();
