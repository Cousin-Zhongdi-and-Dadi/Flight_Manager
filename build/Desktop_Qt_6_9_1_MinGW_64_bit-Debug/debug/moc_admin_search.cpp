...
namespace {
struct qt_meta_tag_ZN12Admin_searchE_t {};
} // unnamed namespace

template <> constexpr inline auto Admin_search::qt_create_metaobjectdata<qt_meta_tag_ZN12Admin_searchE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Admin_search, qt_meta_tag_ZN12Admin_searchE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Admin_search::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12Admin_searchE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12Admin_searchE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12Admin_searchE_t>.metaTypes,
    nullptr
} };
...
void *Admin_search::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12Admin_searchE_t>.strings))
